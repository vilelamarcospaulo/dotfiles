...
function theme.setup()
  ...
  theme.highlights = {
    ...
    Function                    = { fg = p.color5, style = options.styles.functions },
    ...
    Label                       = { fg = p.color4 },
    LineNr                      = { fg = p.color17, bg = p.darker_bg },
    Macro                       = { fg = p.color6 },
    ...
    WinSeparator                = { fg = p.color0, bg = p.background },
    ...
    ["@parameter"]             = { fg = p.color7 },
    ["@parameter.reference"]   = { fg = p.color9 },
    ["@property"]              = { fg = p.color7 },
